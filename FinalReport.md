...
At the start of the project, we established that conducting daily scrums would optimise performance and collaboration and vital to the success of this project. Although it was not daily, we decided to have a Zoom Call three times each week, to inspect, update and synchronise each other on our progress and express any issues impeding their performance.
